...
1. **v0.1**: both protocols, four scenarios, web UI with side-by-side compare, CLI, property tests.
2. **v0.2 (this repo)**: lesson mode with five guided lessons and predict-then-run questions, shareable URLs to a scenario + seed + moment, a fifth scenario (twenty-twenty), Playwright in CI.
